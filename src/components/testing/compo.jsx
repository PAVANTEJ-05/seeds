...
// import { Bitcoin, Zap, RefreshCw, Ethereum } from "lucide-react";
// import DeFiAIAgent from "./DeFiAIAgent";

// // Constants for API endpoints
// const API_ENDPOINTS = {
//   BTC: {
//     FIVE_MINUTES:
//       "https://api.allora.network/v2/allora/consumer/price/ethereum-11155111/BTC/5m",
//     EIGHT_HOURS:
//       "https://api.allora.network/v2/allora/consumer/price/ethereum-11155111/BTC/8h",
//   },
//   ETH: {
//     FIVE_MINUTES:
//       "https://api.allora.network/v2/allora/consumer/price/ethereum-11155111/ETH/5m",
//     EIGHT_HOURS:
//       "https://api.allora.network/allora/consumer/price/ethereum-11155111/ETH/8h",
//   },
//   SOL: {
//     FIVE_MINUTES:
//       "https://api.allora.network/v2/allora/consumer/price/ethereum-11155111/SOL/5m",
//     EIGHT_HOURS:
//       "https://api.allora.network/v2/allora/consumer/ethereum-11155111/SOL/8h",
//   },
// };
...
//   // Create additional state for historical data to pass to AI agent
//   const [poolDayDatas, setPoolDayDatas] = useState([
//     // Sample historical data format that will be populated
//     // { date: '2025-03-09', tvlUSD: 1250000, volumeUSD: 450000, feesUSD: 1350 },
//     // { date: '2025-03-08', tvlUSD: 1240000, volumeUSD: 380000, feesUSD: 1140 }
//   ]);
...
//       // Generate some sample historical pool data for context
//       generateSamplePoolData(data);
//     } catch (error) {
//       console.error("Error fetching current prices:", error);
//     }
//   };

//   // Generate sample pool data based on current prices (for demo purposes)
//   const generateSamplePoolData = (priceData) => {
...
//       // Small random variations for realistic data
//       const randomFactor = 0.95 + Math.random() * 0.1;
//       const randomVolumeFactor = 0.85 + Math.random() * 0.3;

//       historicalData.push({
//         date: dateStr,
//         tvlUSD: Math.round(ethPrice * 5000 * randomFactor),
//         volumeUSD: Math.round(ethPrice * 1200 * randomVolumeFactor),
//         feesUSD: Math.round(ethPrice * 3.6 * randomVolumeFactor),
//         ethPrice: ethPrice * randomFactor,
//         btcPrice: btcPrice * randomFactor,
//         tokenRatio: 0.5 + (Math.random() * 0.1 - 0.05), // Slight imbalance in pool
//         impermanentLoss: (Math.random() * 1.5).toFixed(2) + "%",
//       });
//     }

//     setPoolDayDatas(historicalData);
//   };

//   // Direct fetch from Allora API endpoints
//   const fetchAlloraData = async (url, token, timeframe) => {
//     try {
//       const apiKey = process.env.REACT_APP_ALLORA_API_KEY;
//       const headers = {
...
//       case "ETH":
//         return <Ethereum size={18} className="text-purple-400" />;
//       case "SOL":
//         return (
...
//   // Prepare poolData object to pass to AI agent
//   const poolData = {
//     currentPrices,
//     predictions,
...
//       {/* AI Agent that gets passed the current price and prediction data */}
//       <DeFiAIAgent poolData={poolData} poolDayDatas={poolDayDatas} />
//     </div>
//   );
// }
